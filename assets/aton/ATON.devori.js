/*
	Device-Orientation controls re-adapted from original THREE.DeviceOrientation
*/

class DevOri extends THREE.EventDispatcher {
    ...
    constructor( object ) {
        ...
        const setObjectQuaternion = function ( quaternion, alpha, beta, gamma, orient ) {
            ...
            scope._euler.set( beta, alpha, - gamma, 'YXZ' ); // 'ZXY' for the device, but 'YXZ' for us

            quaternion.setFromEuler( scope._euler ); // orient the device

            quaternion.multiply( scope._q1 ); // camera looks out the back of the device, not the top

            quaternion.multiply( scope._q0.setFromAxisAngle( scope._zee, - orient ) ); // adjust for screen orientation
        ...
        this.update = function () {
            ...
            if ( device ) {
                ...
                if ( 8 * ( 1 - lastQuaternion.dot( scope.object.quaternion ) ) > EPS ) {
                    ...
                    scope.dispatchEvent( scope._changeEvent );
